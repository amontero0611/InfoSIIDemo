...
// endpoints
var cloudantCredentials = vcapServices.getCredentials( 'CloudantVirtualAssist' );
...
app.post( '/api/message', function(req, res) {
  ...
  if ( !workspace || workspace === '<workspace-id>' ) {
    return res.json( {
      'output': {
        'text': 'Esta app has not been configured with a <b>WORKSPACE_ID</b> environment variable. Please refer to the ' +
